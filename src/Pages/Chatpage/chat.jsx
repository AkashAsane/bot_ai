...
export default function Chat() {
    ...
    const handleMessage = () => {
        const responseFound = response.find(item => item.question.toLowerCase() === message.toLowerCase());
        const botResponse = responseFound ? responseFound.response : "Sorry, I can't provide a response.";
